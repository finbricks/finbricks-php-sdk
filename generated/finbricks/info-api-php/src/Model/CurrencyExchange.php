 ...
 */
class CurrencyExchange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrencyExchange';
    ...
    {
        $this->container['sourceCurrency'] = $data['sourceCurrency'] ?? null;
        $this->container['targetCurrency'] = $data['targetCurrency'] ?? null;
     ...
     * Sets sourceCurrency
     *
     * @param string|null $sourceCurrency CurrencyCode, ISO 4217.
     *
     * @return self
     */
     ...
     * Sets targetCurrency
     *
     * @param string|null $targetCurrency CurrencyCode, ISO 4217.
     *
     * @return self
     */
     ...
     * Sets exchangeRate
     *
     * @param float|null $exchangeRate The exchange rate used to charge a payment. Only one rate is filled in, even in the case of cross conversion.
     *
     * @return self
     */
