...
class BankAccountInformationApi
{
     ...
     * @param  string $paymentProvider Supported payment provider codes can be obtained from [/status/paymentProviders](#tag/status) endpoint. (required)
     ...
     * @param  string $operationId End-user identifier assigned by Finbricks.com. &#x60;clientId&#x60; or &#x60;operationId&#x60; is required. For more information, see chapter [Identifiers](#section/Overview/Identifiers). (optional)
     *
     ...
     * @param  string $cursor A pagination cursor returned by a previous call to this endpoint. A cursor is a part of links.value response field. Provide this value to retrieve the next set of results for your original query.  __If the cursor is used in conjunction with other filters, it takes precedence and other filters are ignored.__ (optional)
     *
     * @throws \Finbricks\Api\Info\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Finbricks\Api\Info\Model\AccountTransactions|\Finbricks\Api\Info\Model\Error
     */
    public function accountTransactionsGet($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId = null, $operationId = null, $dateFrom = null, $dateTo = null, $currency = null, $size = null, $page = null, $cursor = null)
    {
        list($response) = $this->accountTransactionsGetWithHttpInfo($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId, $operationId, $dateFrom, $dateTo, $currency, $size, $page, $cursor);
        return $response;
    }
     ...
     */
    public function accountTransactionsGetWithHttpInfo($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId = null, $operationId = null, $dateFrom = null, $dateTo = null, $currency = null, $size = null, $page = null, $cursor = null)
    {
        $request = $this->accountTransactionsGetRequest($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId, $operationId, $dateFrom, $dateTo, $currency, $size, $page, $cursor);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountTransactionsGetAsync($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId = null, $operationId = null, $dateFrom = null, $dateTo = null, $currency = null, $size = null, $page = null, $cursor = null)
    {
        return $this->accountTransactionsGetAsyncWithHttpInfo($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId, $operationId, $dateFrom, $dateTo, $currency, $size, $page, $cursor)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountTransactionsGetAsyncWithHttpInfo($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId = null, $operationId = null, $dateFrom = null, $dateTo = null, $currency = null, $size = null, $page = null, $cursor = null)
    {
        $returnType = '\Finbricks\Api\Info\Model\AccountTransactions';
        $request = $this->accountTransactionsGetRequest($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId, $operationId, $dateFrom, $dateTo, $currency, $size, $page, $cursor);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountTransactionsGetRequest($merchantId, $paymentProvider, $bankAccountId, $signature, $clientId = null, $operationId = null, $dateFrom = null, $dateTo = null, $currency = null, $size = null, $page = null, $cursor = null)
    {
        // verify the required parameter 'merchantId' is set
        if ($merchantId === null || (is_array($merchantId) && count($merchantId) === 0)) {
            throw new \InvalidArgumentException(
