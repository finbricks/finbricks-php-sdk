 ...
 */
class AuthenticateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticateResponse';
    ...
    const AUTH_STATUS_AUTH_NOT_NEEDED = 'auth_not_needed';
    ...
    public function getAuthStatusAllowableValues()
    {
        return [
            ...
            self::AUTH_STATUS_AUTH_NOT_NEEDED,
        ];
    }
     ...
     * Sets operationId
     *
     * @param string|null $operationId End-user identifier assigned by Finbricks.com. For more information, see chapter [Identifiers](#section/Overview/Identifiers).
     *
     * @return self
     */
