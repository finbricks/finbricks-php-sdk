...
class BankIdApi
{
     ...
     * @return void
     */
    public function bankIdLogout($merchantId, $signature, $clientIdForBankId, $provider)
    {
        $this->bankIdLogoutWithHttpInfo($merchantId, $signature, $clientIdForBankId, $provider);
    }

    /**
     * Operation bankIdLogoutWithHttpInfo
     *
     * Logout end-user from BankId
     *
     * @param  string $merchantId Unique merchant identifier from merchant registration process (required)
     ...
     */
    public function bankIdLogoutWithHttpInfo($merchantId, $signature, $clientIdForBankId, $provider)
    {
        $request = $this->bankIdLogoutRequest($merchantId, $signature, $clientIdForBankId, $provider);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankIdLogoutAsync($merchantId, $signature, $clientIdForBankId, $provider)
    {
        return $this->bankIdLogoutAsyncWithHttpInfo($merchantId, $signature, $clientIdForBankId, $provider)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bankIdLogoutAsyncWithHttpInfo
     *
     * Logout end-user from BankId
     *
     * @param  string $merchantId Unique merchant identifier from merchant registration process (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bankIdLogoutAsyncWithHttpInfo($merchantId, $signature, $clientIdForBankId, $provider)
    {
        $returnType = '';
        $request = $this->bankIdLogoutRequest($merchantId, $signature, $clientIdForBankId, $provider);
    ...
    /**
     * Create request for operation 'bankIdLogout'
     *
     * @param  string $merchantId Unique merchant identifier from merchant registration process (required)
     * @param  string $signature Signature of the request. For more information, see chapter [Signing the request](#section/Security/Signing-the-request). (required)
     * @param  string $clientIdForBankId Id identifying the end user at the merchant. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bankIdLogoutRequest($merchantId, $signature, $clientIdForBankId, $provider)
    {
        // verify the required parameter 'merchantId' is set
        if ($merchantId === null || (is_array($merchantId) && count($merchantId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $merchantId when calling bankIdLogout'
            );
        }
        // verify the required parameter 'signature' is set
        if ($signature === null || (is_array($signature) && count($signature) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $signature when calling bankIdLogout'
            );
        }
        // verify the required parameter 'clientIdForBankId' is set
        if ($clientIdForBankId === null || (is_array($clientIdForBankId) && count($clientIdForBankId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $clientIdForBankId when calling bankIdLogout'
            );
        }
        if (strlen($clientIdForBankId) > 100) {
            throw new \InvalidArgumentException('invalid length for "$clientIdForBankId" when calling BankIdApi.bankIdLogout, must be smaller than or equal to 100.');
        }

        // verify the required parameter 'provider' is set
        if ($provider === null || (is_array($provider) && count($provider) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $provider when calling bankIdLogout'
            );
        }

        $resourcePath = '/bankId/logout';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
