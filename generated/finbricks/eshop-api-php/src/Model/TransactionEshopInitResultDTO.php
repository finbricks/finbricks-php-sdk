...
/**
 * TransactionEshopInitResultDTO Class Doc Comment
 *
 * @category Class
 * @package  Finbricks\Api\Eshop
 * @author   OpenAPI Generator team
 ...
 */
class TransactionEshopInitResultDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionEshopInitResultDTO';
     ...
     * Sets redirectUrl
     *
     * @param string $redirectUrl Merchant (e-shop) should redirect the end-user in the browser to this URL
     *
     * @return self
     */
