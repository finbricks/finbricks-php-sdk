<?php
/**
 * TransactionZaplacenoPlusInitDTOAllOf
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * TransactionZaplacenoPlusInitDTOAllOf Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionZaplacenoPlusInitDTOAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionZaplacenoPlusInitDTO_allOf';
    ...
    public function setInitiatorName($initiatorName)
    {
        if (!is_null($initiatorName) && (mb_strlen($initiatorName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $initiatorName when calling TransactionZaplacenoPlusInitDTOAllOf., must be smaller than or equal to 50.');
        }
