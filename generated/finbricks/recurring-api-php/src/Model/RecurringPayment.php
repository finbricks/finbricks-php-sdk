...
class RecurringPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parties' => '\Finbricks\Api\Recurring\Model\RecurringPaymentParties',
     ...
     * Gets parties
     *
     * @return \Finbricks\Api\Recurring\Model\RecurringPaymentParties|null
     */
     ...
     * Sets parties
     *
     * @param \Finbricks\Api\Recurring\Model\RecurringPaymentParties|null $parties parties
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 140)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RecurringPayment., must be smaller than or equal to 140.');
        }
