...
/**
 * TransactionInitResultDTO Class Doc Comment
 *
 * @category Class
 * @package  Finbricks\Api\Platform
 * @author   OpenAPI Generator team
 ...
 */
class TransactionInitResultDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionInitResultDTO';
     ...
     * Sets redirectUrl
     *
     * @param string $redirectUrl Client (platform) should call redirect in browser to this URL after this response is get.
     *
     * @return self
     */
