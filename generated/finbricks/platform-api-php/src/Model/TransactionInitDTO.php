...
class TransactionInitDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets clientId
     *
     * @param string|null $clientId Identification of a client (end-user). If the client has been authenticated before and his authentication in the bank is still valid, the step of user authentication in Zaplaceno.cz will be skipped. Otherwise standard authentication will be required.
     *
     * @return self
     */
